...
import 'package:reference_project_flutter/features/blog_app/carousel/carousel_slider.dart';
import 'package:reference_project_flutter/features/blog_app/gen/fonts.gen.dart';
import 'package:reference_project_flutter/features/blog_app/screen/article.dart';
import 'package:reference_project_flutter/features/blog_app/screen/story/story.dart';
import 'package:reference_project_flutter/features/blog_app/utils/models/data.dart';
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(Icons.notification_add,weight: 32,)
                  ],
                ),
              ),
              Padding(
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  bottom: 0,
                  child: Image.asset(
                    'assets/img/icon/${story.iconFileName}',
                    width: 24,
                    height: 24,
                  ),
                )
        ...
        child: Row(
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(16),
              child:
              Image.asset(post.imageFileName,width: 150,fit: BoxFit.cover,height: double.infinity,),
            ),
            Expanded(
              child: Padding(
