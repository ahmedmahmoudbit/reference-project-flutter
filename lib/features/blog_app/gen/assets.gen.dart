...
class $AssetsImgBackgroundGen {
  ...
  /// File path: assets/img/background/splash.png.jpg
  AssetGenImage get splashPng =>
      const AssetGenImage('assets/img/background/splash.png.jpg');

  /// File path: assets/img/background/story-content.png
  AssetGenImage get storyContent =>
      const AssetGenImage('assets/img/background/story-content.png');

  /// File path: assets/img/background/story.png.jpg
  AssetGenImage get storyPng =>
      const AssetGenImage('assets/img/background/story.png.jpg');

  /// List of all assets
  List<AssetGenImage> get values =>
      [onboarding, singlePost, splashPng, storyContent, storyPng];
}
