...
import 'package:reference_project_flutter/features/moviess/models/model_movies.dart';
...
final movies = [
  Movie(
    name: 'Greta ',
    image: 'assets/img/background/splash.png.jpg',
    screenPreview: 'assets/img/background/splash.png.jpg',
    description:
  ...
  Movie(
    ...
    screenPreview: 'assets/images/test1.jpg',
    description:
    'A kind-hearted street urchin and a power-hungry Grand Vizier vie for '
        'a magic lamp that has the power to make their deepest wishses come true.',
    type: 'Fantasy',
  ...
  Movie(
    name: 'Aladdin 2 ',
    image: 'assets/img/background/story.png.jpg',
    screenPreview: 'assets/img/background/story.png.jpg',
    description:
    'A kind-hearted street urchin and a power-hungry Grand Vizier vie for '
        'a magic lamp that has the power to make their deepest wishses come true.',
    type: 'Fantasy',
